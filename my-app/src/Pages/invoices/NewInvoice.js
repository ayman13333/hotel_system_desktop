...
export default function NewInvoice() {
    ...
    const handleDownload = async () => {
        ...
        const canvas = await html2canvas(element,{scale:4}); // Increase scale for better quality
        ...
        pdf.addImage(imgData, 'JPEG', xOffset, yOffset, imgScaledWidth, imgScaledHeight, null, 'FAST'); // 'FAST' compression mode


        //   doc.save(`فاتورة-رقم-${result?.serialNumber}-حجز جديد.pdf`);

        // Save PDF
        pdf.save(`فاتورة-رقم-${location?.state?.serialNumber}-حجز جديد.pdf`);
    ...
    let to = FormatDate(new Date(location?.state?.to));                           //      new Date(to).toISOString().split('T')[0];


    console.log('to', location?.state?.to.toISOString().split('T')[0]);
                ...
                <div className="invoice-container">
                    ...
                    <div className="invoice-body">
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {/* <td className='text-center'>{location?.state?.bookDate.toISOString().split('T')[0]} </td> */}
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        style={{fontWeight:'bolder'}}
                                          >
                                          <h4 style={{fontWeight:'bolder'}}> اجمالي المبلغ المدفوع </h4> 
                                           </td>
                                        <td className='text-center' 
                                        style={{fontWeight:'bolder'}}
                                         >
                        ...
                        <div className="invoice-actions">
                            ...
                            } className="btn btn-danger"> رجوع </button>
                        </div>
                    </div>
                </div>
            </section>
