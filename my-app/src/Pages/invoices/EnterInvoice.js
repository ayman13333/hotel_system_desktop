...
export default function EnterInvoice() {
    ...
    console.log('arrivalDate', location.state.arrivalDate);
                        ...
                        <div className="invoice-table">
                            <table className="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td className='text-center'>  تاريخ  الاستكمال </td>
...

                                    {
                                        location?.state?.isTransferred && <tr>
                                            <td className='text-center'>  تاريخ نقل الحجز </td>
                                            <td className='text-center'>{FormatDate(new Date(location?.state?.arrivalDate))} </td>
                                        </tr>
                                    }
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-center' >{
                                            location?.state?.isTransferred ? 'رقم الغرفه المنقول اليها' : 'رقم الغرفة'
                                        }   </td>
                                        <td className='text-center' > {location?.state?.roomID?.room_number} </td>
                                    </tr>
                                    {
                                        location?.state?.isTransferred && <tr>
                                            <td className='text-center' > رقم الغرفة السابقة </td>
                                            <td className='text-center' > {location?.state?.prevRoomID?.room_number} </td>
                                        </tr>
                                    }
                                            ...
                                            <h4 style={{ fontWeight: 'bolder' }}>
                                                {
                                                    ...
                                                    (location?.state?.isTransferred && location?.state?.paidPrice == 0) ?
                                                        `${location?.state?.paidPrice} L.E   (  نقل مجاني )`
                                                        :
                                                        `${location?.state?.paidPrice} L.E`
                                                }
